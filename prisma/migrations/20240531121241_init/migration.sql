-- CreateEnum
CREATE TYPE "Role" AS ENUM ('USER', 'ADMIN', 'STORE');

-- CreateEnum
CREATE TYPE "Category" AS ENUM ('SEED', 'FERTILIZER');
...
CREATE TABLE "Product" (
    ...
    "maxPerAcre" DOUBLE PRECISION NOT NULL,
    "perAcre" DOUBLE PRECISION NOT NULL,
    "seedIds" INTEGER[] DEFAULT ARRAY[]::INTEGER[],
